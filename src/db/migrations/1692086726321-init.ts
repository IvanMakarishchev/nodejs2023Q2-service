...
export class Init1692086726321 implements MigrationInterface {
  name = 'Init1692086726321';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "fav_albums" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "albumId" uuid NOT NULL, CONSTRAINT "PK_6c77bca2014469e107d68d25187" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "fav_artists" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "artistId" uuid NOT NULL, CONSTRAINT "PK_e57499b114b13031b5a5ac8f95c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "fav_tracks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trackId" uuid NOT NULL, CONSTRAINT "PK_5288c864aa552bb91690d9c4297" PRIMARY KEY ("id"))`,
    );
  }
